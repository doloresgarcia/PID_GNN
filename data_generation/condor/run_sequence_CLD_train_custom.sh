...
# Create Tree 
python make_pftree_clic_bindings_tautau.py out_reco_edm4hep_edm4hep.root tree7.root False False ${IDX}

mkdir -p ${OUTPUTDIR}
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py tree7.root ${OUTPUTDIR}/pf_tree_${SEED}.root
